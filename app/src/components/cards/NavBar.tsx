        ...
        <div className={`w-full xl:block xl:w-auto items-center ${dropDownActive ? 'block' : 'hidden' }`} id="navbar-default">
            <ul className="font-medium gap-8 flex flex-col p-4 xl:p-0 mt-4 xl:flex-row xl:space-x-8 xl:mt-0 xl:items-center">
              ...
              { href: portfolio.greeting.resumeLink, label: "📄 Currículo" },
                    ...
                    >
                        <a href={link.href} className={`block cursor-pointer text-xl py-2 px-6 bg-transparent text-button-color transition ease-in-out hover:bg-button-color hover:text-sky-400 focus:bg-button-color focus:text-white active:bg-button-color active:text-white duration-300`}>
                            {link.label}
                        </a>
