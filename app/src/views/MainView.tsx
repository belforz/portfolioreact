...
export default function MainView() {
  ...
  return (
    <div
      className={`min-h-screen overscroll-contain bg-${darkModeActive ? "black" : "white"} ${darkModeActive ? "text-white" : "text-slate-700"} text-base md:text-xl`}
    >
              ...
              <li className="transition-all motion-reduce:transition-none duration-500">
                <a href={portfolio.socialMediaLinks.github} target="_blank">
                  <img
                    src={
                      darkModeActive
                        ? "assets/github-copilot-branco.png"
                        : "assets/github-icon-novo.svg"
                    }
