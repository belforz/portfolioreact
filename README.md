# 📋 Projeto de Portfólio Vue - Apresentação Pessoal

Bem-vindo ao repositório do meu **portfólio pessoal em React**! Este projeto foi desenvolvido para apresentar meus conhecimentos em **React**, **Tailwind CSS**, e criar uma experiência interativa para compartilhar minha trajetória profissional, habilidades e projetos.
